                ...
                <div class="col">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">{{ __('Thống kê doanh thu') }}</li>
                        </ol>
                    </nav>
                </div>
            </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h2 class="mb-0">{{ __('Biểu đồ doanh thu') }}</h2>
                        </div>
                        <div class="card-body">
                            <x-form class="row" :action="route('admin.statistic.revenue')" type="get" :validate="true">
