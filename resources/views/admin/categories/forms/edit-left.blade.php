        ...
        <div class="row card-body">
            ...
            <div class="col-12">
                <div class="mb-3">
                    ...
                    <x-input name="slug" :value="$category->slug" :required="true" placeholder="{{ __('Slug') }}" />
                </div>
            </div>
            <!-- Chuyên mục cha -->
            <div class="col-md-12 col-sm-12">
            ...
            <div class="col-12">
                <div class="mb-3">
                    ...
                    <x-input name="title_seo" :value="$category->title_seo" placeholder="{{ __('Tiêu đề seo') }}" />
                </div>
            </div>
            <!-- desc seo -->
            <div class="col-12">
                <div class="mb-3">
                    ...
                    <textarea class="form-control" name="desc_seo" rows="5">{{ $category->desc_seo }}</textarea>
                </div>
            </div>
        </div>
    </div>
