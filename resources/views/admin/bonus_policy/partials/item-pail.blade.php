@foreach ($bonus_policy_pail->detail as $value)
    <tr>
        <td>{{ $value->point }} <span class="badge bg-orange-lt">@lang('thùng')</span></td>
        <td>
            <span class="display-value">  {{ $value->bonus }} <span class="badge bg-orange-lt">@lang('đồng')</span>
          </span>
