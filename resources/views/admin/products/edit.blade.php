...
@push('libs-css')
{{-- <link rel="stylesheet" href="{{ asset('public/libs/tabler/plugins/star-rating/dist/star-rating.min.css') }}"> --}}
@endpush
@push('custom-css')
    <style>
    </style>
...
{{-- <script src="{{ asset('public/libs/tabler/plugins/star-rating/dist/star-rating.min.js') }}"></script> --}}
