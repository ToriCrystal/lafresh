<div class="information-orders">
    <div class="card-header mb-3">
        <ul class="nav nav-tabs card-header-tabs nav-fill" data-bs-toggle="tabs" role="tablist">
            <li class="nav-item" role="presentation">
                <a href="#tabs-all-orders" class="nav-link active" data-bs-toggle="tab" aria-selected="true" role="tab">
                    Tất cả đơn
                </a>
            </li>
            <li class="nav-item" role="presentation">
    ...
    <div class="mb-3">
        <div class="input-icon mb-3">
            <input type="text" value="" class="form-control shadow-none" placeholder="Tìm kiếm đơn hàng...">
