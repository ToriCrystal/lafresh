...
<x-form :action="route('manager_employee.store')" type="post" :validate="true">
    <div class="card-body row align-items-center">
        <div class="col-lg-6 col-12">
            <div class="mb-3">
                <label class="form-label required">@lang('fullname')</label>
                <x-input type="fullname" class="shadow-none" name="fullname" :value="old('fullname')"
        ...
        <div class="col-lg-6 col-12">
            <div class="mb-3">
                ...
                <x-input-email class="shadow-none" name="email" :value="old('email')" :required="true" :placeholder="trans('Địa chỉ email')" />
            </div>
        </div>
        <div class="col-lg-6 col-12">
            <div class="mb-3">
                <label class="form-label required">@lang('phone')</label>
                <x-input-phone class="shadow-none" name="phone" :value="old('phone')" :required="true" :placeholder="trans('Số điện thoại')" />
            </div>
        </div>
        ...
        <div class="col-lg-6 col-12">
            <div class="mb-3">
                ...
                <x-input type="date" class="shadow-none" name="birthday" :value="old('birthday')" />
            </div>
        </div>
        ...
        <div class="col-lg-6 col-12">
            <div class="mb-3">
                ...
                <x-input class="shadow-none" name="address" :value="old('address')" :placeholder="trans('address')" />
            </div>
        </div>
        <div class="col-lg-6 col-12">
            <div class="mb-3">
    ...
    <x-button type="submit" class="ms-auto btn-cyan mt-3">@lang('add')</x-button>
</x-form>
@endsection
